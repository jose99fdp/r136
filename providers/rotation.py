...
class RotationProvider:
    """
    The yandaai provider rotates between available providers to handle requested based on token limits.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.agent_name = kwargs.get("agent_name", "yandaai")
    ...
    async def inference(
        ...
        excluded_providers = {"yandaai", "rotation", "gpt4free", "default"}
