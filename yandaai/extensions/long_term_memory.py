...
class long_term_memory(Extensions):
    """
    The Long Term Memory extension enables yandaai to create and manage persistent memory databases.
    ...
    async def list_memory_databases(self):
        ...
        - Ryandaaiwing available knowledge categories
    ...
    async def retrieve_memories(self, query: str):
        ...
        The agent will:
        1. Ryandaaiw available memory databases
