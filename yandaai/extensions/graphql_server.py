...
class graphql_server(Extensions):
    """
    The GraphQL Server extension for yandaai enables you to interact with a GraphQL API endpoint. By default, if a GraphQL endpoint is not provided, this extension is directly connected to the yandaai GraphQL server.
    """
